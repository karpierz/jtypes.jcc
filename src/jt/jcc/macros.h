...
#define DECLARE_METHOD(type, name, flags) { #name, (PyCFunction) type##_##name, flags, "" }

#define DECLARE_GET_FIELD(type, name)     { #name, (getter) type##_get__##name, NULL, "", NULL }

#define DECLARE_SET_FIELD(type, name)     { #name, NULL, (setter) type##_set__##name, "", NULL }

#define DECLARE_GETSET_FIELD(type, name)  { #name, (getter) type##_get__##name, (setter) type##_set__##name, "", NULL }
